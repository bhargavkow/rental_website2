...
// const PRODUCTS = [
//     { id: 21, name: 'Casual Shirt', category: 'Tops', size: 'S', brand: 'zara', color: 'blue', price: 2500, imageUrl: children_cloth1 },
//     { id: 22, name: 'Slim Fit Shirt', category: 'slim', size: 'L', brand: 'h&m', color: 'black', price: 3000, imageUrl: children_cloth2 },
//     { id: 23, name: 'Slim Fit Shirt', category: 'fit', size: 'S', brand: 'Zudio', color: 'black', price: 3000, imageUrl: children_cloth3 },
//     { id: 24, name: 'Checked Shirt', category: 'Tops', size: 'M', brand: 'us polo', color: 'red', price: 3500, imageUrl: children_cloth4 },
//     { id: 25, name: 'Denim Shirt', category: 'Tops', size: 'L', brand: 'allen solley', color: 'blue', price: 4000, imageUrl: children_cloth5 },
//     { id: 26, name: 'White Shirt', category: 'Tops', size: 'M', brand: 'red tape', color: 'white', price: 2008, imageUrl: children_cloth6 },
//     { id: 27, name: 'Printed Shirt', category: 'Tops', size: 'XL', brand: 'arrow', color: 'black', price: 5005, imageUrl: children_cloth7 },
//     { id: 28, name: 'Casual Shirt', category: 'Tops', size: 'M', brand: 'zara', color: 'blue', price: 2500, imageUrl: children_cloth1 },
//     { id: 29, name: 'Slim Fit Shirt', category: 'Tops', size: 'L', brand: 'zara', color: 'black', price: 3000, imageUrl: children_cloth9 },
//     { id: 30, name: 'Checked Shirt', category: 'Tops', size: 'S', brand: 'zara', color: 'red', price: 3005, imageUrl: children_cloth10 },
//     { id: 31, name: 'Denim Shirt', category: 'Tops', size: 'L', brand: 'zara', color: 'blue', price: 4000, imageUrl: children_cloth11 },
//     { id: 32, name: 'White Shirt', category: 'Tops', size: 'M', brand: 'zara', color: 'white', price: 2800, imageUrl: children_cloth1 },
//     { id: 33, name: 'Printed Shirt', category: 'Tops', size: 'XL', brand: 'zara', color: 'black', price: 5500, imageUrl: children_cloth1 },
// ];
